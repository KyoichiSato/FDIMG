...
22:26 - 22:35 2HD DOS
22:38 - 22:47 2HD DOS
DISKBASICのフロッピー（1シリンダ26セクタ）を読めるようにIDをたくさん読むようにしたら、2HD 1枚 10分掛かるようになった。
IDの並びを調べるのが遅い。
...
/*BIOSで8回リトライするので、自前のリトライは無し*/
/*#define TRYCOUNT	5*/	/*セクタリード時リトライカウント*/
/*フォーマット判別時はエラーなら別のトラックを読む*/
#define TRYFCOUNT	20	/*フォーマット判別時リトライカウント*/
